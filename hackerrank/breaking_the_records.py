...
# times she broke her records. Index  is for breaking most points records, and index  is for breaking least points
# records.
#
...
# we print 2 4 as our answer. Note that she did not break her record for best score during game 3, as her score during
...
def breaking_records(scores):
    min_score, max_score, min_count, max_count = scores[0], scores[0], 0, 0
